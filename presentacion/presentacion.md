---
marp: true
theme: alfabetizacion
paginate: true
footer: "CC BY-NC 4.0 · Juan David Rodríguez García · Alfabetización en IA"
lang: es
title: "Alfabetización en IA: aprender a crear para comprender"
author: "Juan David Rodríguez García"
description: "Sesión de un curso de IA para docentes. Machine Learning con LearningML e IA generativa con Glass Parrot."
---
...
![bg right:46% fit](img/portada.png)

# Alfabetización en IA

<div class="sub">aprender a crear para comprender</div>
...
![bg right:46% fit](img/ia-todoterreno.png)
...
![bg right:46% fit](img/sandbox.png)
...
<div class="aviso">Según prensa y Wikipedia (sept. 2026). Las cifras varían según la fuente.</div>
...
![bg right:46% fit](img/alarma.png)
...
![bg right:46% fit](img/docente-robot.png)
...
![bg right:46% fit](img/humano-centro.png)
...
![bg right:46% fit](img/pioneros.png)
...
![bg right:46% fit](img/eclipse.png)
...
![bg right:46% fit](img/caja-negra.png)
...
![bg right:46% fit](img/maquina-habla.png)
...
![w:1140](img/historia-escritura.png)
...
![bg right:46% fit](img/descarga.png)
...
![bg right:46% fit](img/hard-fun.png)
...
![bg right:46% fit](img/mapa-aprendizajes.png)
...
![w:1140](img/prog-tradicional.png)
...
![w:1137](img/digitos-variados.png)
...
![bg right:46% fit](img/construccionismo.png)
...
![w:1137](img/clasificaciones.png)
...
![bg right:44% fit](img/scratch-bloques.png)
...
![bg right:50% fit](img/cuadrantes.png)
...
![bg right:46% fit](img/autocompletar.png)
...
![w:995](img/entrenamiento-llm.png)
...
![bg right:50% fit](img/probabilidades.png)
...
![bg right:46% fit](img/loro-cristal.png)
...
<div class="aviso">Los hechos del verano de 2026 proceden de prensa y fuentes secundarias: contrástalos antes de citarlos.</div>
...
![bg right:40% fit](img/portada.png)
